...
import med.vell.api.domain.consulta.Consulta;
import med.vell.api.domain.endereco.DadosEndereco;
import med.vell.api.domain.paciente.DadosCadastroPaciente;
...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando úinico médico cadastrado não está disponível na data")
